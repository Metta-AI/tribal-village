...
- **Wolves** spawn in packs (3-5) and each wolf gets a shared `packId`.
...
- **Wolves**
  ...
  - Packs hunt nearby tumors or agents within `WolfPackAggroRadius`.
  - Wolves keep cohesion: if a wolf is far from the pack center, it returns to the center.
- **Bears**
