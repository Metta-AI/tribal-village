## errors.nim - Error types and FFI error state management
##
## Provides type-safe error handling for the tribal village simulation,
## replacing silent failures and quit() calls with proper exceptions.
