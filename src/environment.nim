...
proc rebuildObservations*(env: Environment) =
  ...
  ## Optimization: only zero observations for alive agents, not the full array.
  ## This significantly reduces startup overhead since most agent slots are terminated.
