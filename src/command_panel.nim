...
##
## Uses silky stubs (sk.drawRect/drawText) for button rendering.
## These calls go through no-op stubs since silky was never fully integrated.
## TODO: Migrate to boxy-based rendering like the rest of the UI.
...
const
  ...
  # Font identifiers passed to silky stub (no-op)
