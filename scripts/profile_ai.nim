...
proc countHouses(env: Environment): array[MapRoomObjectsHouses, int] =
  var counts: array[MapRoomObjectsHouses, int]
...
proc updateMaxHearts(env: Environment, maxHearts: var array[MapRoomObjectsHouses, int]) =
...
proc formatCounts(label: string, counts: array[MapRoomObjectsHouses, int]): string =
...
when isMainModule:
  ...
  var maxHearts: array[MapRoomObjectsHouses, int]
